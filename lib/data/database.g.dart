...
class TransactionRow extends DataClass implements Insertable<TransactionRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || counterpartId != null) {
      map['counterpart_id'] = Variable<int>(counterpartId);
    }
    map['created_at'] = Variable<DateTime>(createdAt);
    return map;
  }
  ...
  TransactionsCompanion toCompanion(bool nullToAbsent) {
    return TransactionsCompanion(
      ...
      note: Value(note),
      type: Value(type),
      counterpartId: counterpartId == null && nullToAbsent
          ? const Value.absent()
          : Value(counterpartId),
      createdAt: Value(createdAt),
    );
  ...
  factory TransactionRow.fromJson(
    ...
    return TransactionRow(
      ...
      counterpartId: serializer.fromJson<int?>(json['counterpartId']),
      createdAt: serializer.fromJson<DateTime>(json['createdAt']),
    );
  }
  @override
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'counterpartId': serializer.toJson<int?>(counterpartId),
      'createdAt': serializer.toJson<DateTime>(createdAt),
    };
  }
  ...
  TransactionRow copyWith({
    ...
    Value<int?> counterpartId = const Value.absent(),
    DateTime? createdAt,
  }) => TransactionRow(
    id: id ?? this.id,
    ...
    note: note ?? this.note,
    type: type ?? this.type,
    counterpartId: counterpartId.present
        ? counterpartId.value
        : this.counterpartId,
    createdAt: createdAt ?? this.createdAt,
  );
...
class TransactionsCompanion extends UpdateCompanion<TransactionRow> {
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (counterpartId.present) {
      map['counterpart_id'] = Variable<int>(counterpartId.value);
    }
    if (createdAt.present) {
      map['created_at'] = Variable<DateTime>(createdAt.value);
    }
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final Index idxTransactionsAbsAmount = Index(
    'idx_transactions_abs_amount',
    'CREATE INDEX idx_transactions_abs_amount ON transactions (ABS(amount_minor))',
  );
...
final class $$TransactionsTableReferences
  ...
  static $TransactionsTable _counterpartIdTable(_$AppDatabase db) => db
      .transactions
      .createAlias('transactions__counterpart_id__transactions__id');

  $$TransactionsTableProcessedTableManager? get counterpartId {
    final $_column = $_itemColumn<int>('counterpart_id');
    if ($_column == null) return null;
    final manager = $$TransactionsTableTableManager(
      $_db,
      $_db.transactions,
    ).filter((f) => f.id.sqlEquals($_column));
    final item = $_typedResult.readTableOrNull(_counterpartIdTable($_db));
    if (item == null) return manager;
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: [item]),
    );
...
class $$TransactionsTableFilterComposer
  ...
  $$TransactionsTableFilterComposer get counterpartId {
    final $$TransactionsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.counterpartId,
      referencedTable: $db.transactions,
      getReferencedColumn: (t) => t.id,
      builder:
          (
...
class $$TransactionsTableOrderingComposer
  ...
  $$TransactionsTableOrderingComposer get counterpartId {
...
class $$TransactionsTableAnnotationComposer
  ...
  $$TransactionsTableAnnotationComposer get counterpartId {
    final $$TransactionsTableAnnotationComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.counterpartId,
      referencedTable: $db.transactions,
    ...
    : super(
        TableManagerState(
          ...
          withReferenceMapper: (p0) => p0
              ...
              .toList(),
          prefetchHooksCallback:
              ({accountId = false, categoryId = false, counterpartId = false}) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [],
                  addJoins:
                      ...
                      >(state) {
                        ...
                        if (counterpartId) {
                          state = state.withJoin(
                            currentTable: table,
                            currentColumn: table.counterpartId,
                            referencedTable: $$TransactionsTableReferences
                                ._counterpartIdTable(db),
                            referencedColumn: $$TransactionsTableReferences
                                ._counterpartIdTable(db)
                                .id,
                          ) as T;
